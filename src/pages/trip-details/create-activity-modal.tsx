...
export function CreateActivityModal({
  ...
  return (
    <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
      <div className='w-[492px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
        ...
        <form className='space-y-3'>
          ...
          <div className="flex gap-2">
            <div className='h-14 px-4 w-72 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
