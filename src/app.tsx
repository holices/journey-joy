...
export function App() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState([
    'holicesjr@gmail.com',
    'joaosanson01@gmail.com',
    'jullyvieira16@gmail.com'
  ])
      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className='space-y-4'>
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            {isGuestsInputOpen ? (
              <button onClick={closeGuestsInput} className='bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:text-zinc-100 hover:bg-zinc-700'>
                Alterar local/data
        ...
        <p className="text-sm text-zinc-500">
          Ao planejar sua viagem com Journey Joy você concorda <br/>
          automaticamente com nossos <a href="#" className="text-zinc-300 underline">termos de uso</a> e <a href="#" className="text-zinc-300 underline">políticas de privacidade</a>.
        </p>
      </div>
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            <div className='space-y-2'>
              ...
              <p className='text-sm to-zinc-400'>
